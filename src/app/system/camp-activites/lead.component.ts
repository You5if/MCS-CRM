...
import { CActivitesEntryComponent } from './lead-entry/lead-entry.component';
...
export class CActivitesComponent implements OnInit {

  displayedColumns: string[] =
  ['fullName','fullName2','custType', 'leadSt'];
...
role = localStorage.getItem("role");
  ...
  ngOnInit() {
    this.titleService.setTitle("CRM | Campaign Activites");
      this.refreshMe();
  }
  ...
  refreshMe() {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      this.direction = "ltr"
      this.header = "Campaign Activites"
      this.leadId = "leadId"
      this.fullName = "Code"
      this.fullName2 = "Name"
      this.custType = "Campagin"
      this.leadSt = "Supervisor"
      ...
      this.submit = "Submit"
      this.cancel = "Cancel"
      this.headerToShow = [this.fullName ,this.fullName2,  this.custType, this.leadSt]
    }else if(localStorage.getItem(this._globals.baseAppName + '_language') == "16002") {
      this.direction = "rtl"
      this.header = "ملف الحملة"
      this.leadSt = "بدأ"
      this.fullName = "الرمز"
      this.fullName2 = "الاسم"
      this.custType = "الحملة"
      this.leadSt = "المسؤول"
  ...
  onAdd  () {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "Add Activity");
    }else if(localStorage.getItem(this._globals.baseAppName + '_language') == "16002") {
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "اضافة نشاط");
    }
  ...
  openEntry  (result: LeadModel) {
    if (result === undefined) {
      const dialogRef = this.dialog.open(CActivitesEntryComponent, {
        disableClose: true,
        data: {}
      });
