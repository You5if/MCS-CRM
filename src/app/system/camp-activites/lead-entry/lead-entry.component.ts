...
export class CActivitesEntryComponent implements OnInit {

  dummy = {
    campId: 0,
    campName:'' ,
    actCode: 'ACT00'+(this.dummyService.campActivities.length + 1).toString(),
    actName: '',
    campObjective: '',
...
campHost = [
  ...
  constructor(
      ...
      private dialogRef: MatDialogRef<CActivitesEntryComponent>,
