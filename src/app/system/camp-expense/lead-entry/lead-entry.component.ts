...
export class CExpenseEntryComponent implements OnInit {
...
campHost = [
  ...
  constructor(
      ...
      private dialogRef: MatDialogRef<CExpenseEntryComponent>,
  ...
  onSubmit() {
    ...
    this.campCurrency.forEach((index) => {
      if(index.id === this.dummy.campId){
        this.dummy.currency = index.name
      }
    })
   
    this.dummyService.campExpense.push(this.dummy)
