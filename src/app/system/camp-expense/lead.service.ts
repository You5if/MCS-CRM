...
export class LeadService {
   ...
   getLeadEntry(id: number): Observable<LeadModel> {
      return this.httpClient.get<LeadModel>(this._globals.baseAPIUrl + 'CampExpense/' + id).pipe(
   ...
   getLeadSubmit(data: LeadModel) {
      ...
      switch (data.entryMode) {
          ...
          case 'A': {
          return this.http.post(this._globals.baseAPIUrl + 'CampExpense/create', data, this._cf.requestOptions()).pipe(
          ...
          case 'E': {
          return this.http.post(this._globals.baseAPIUrl + 'CampExpense/edit', data, this._cf.requestOptions()).pipe(
          map((response: Response) => {
          return response.json();
          }), catchError(this._cf.handleError));
          }
          ...
          case 'D': {
          return this.http.post(this._globals.baseAPIUrl + 'CampExpense/delete', data, this._cf.requestOptions()).pipe(
          map((response: Response) => {
          return response.json();
          }), catchError(this._cf.handleError));
          }
