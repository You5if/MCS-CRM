...
import { CExpenseEntryComponent } from './lead-entry/lead-entry.component';
...
export class CExpenseComponent implements OnInit {
...
role = localStorage.getItem("role");
    ...
    this._cf.getPageData('Lead', this.pScreenId, this._auth.getUserId(), this.pTableId,
      this.recordsPerPage, this.currentPageIndex, false).subscribe(
        (result) => {
          ...
          console.log(this.dummyService.campExpense);
          
          this.totalRecords = this.dummyService.campExpense.length;
          this.recordsPerPage = this.recordsPerPage;
          this.dataSource = new MatTableDataSource(this.dummyService.campExpense);
          this.indexes = this.dummyService.campExpense
        }
      );
      ...
      this._cf.getPageDataOnPaginatorOperation(event, this.pTableName, this.pScreenId, this._auth.getUserId(),
        this.pTableId, this.totalRecords).subscribe(
          (result: any) => {
            ...
            this.dataSource = this.dummyService.campExpense;
          }, error => {
            // this._ui.loadingStateChanged.next(false);
  ...
  onAdd  () {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      ...
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "اضافة منصرف");
    }
  ...
  openEntry  (result: LeadModel) {
    if (result === undefined) {
      const dialogRef = this.dialog.open(CExpenseEntryComponent, {
        disableClose: true,
        data: {}
      });
