...
role = localStorage.getItem("role");
  ...
  refreshMe() {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      ...
      this.submit = "Submit"
      this.cancel = "Cancel"
      this.headerToShow = [this.fullName ,this.leadSt,  this.custType]
    ...
    this._cf.getPageData('CampExpense', this.pScreenId, this._auth.getUserId(), this.pTableId,
  ...
  onEdit = (id: number) => {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      ...
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "تعديل منصرف");
    }
