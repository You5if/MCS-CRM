...
export class LeadService {
   ...
   getLeadEntry(id: number): Observable<LeadModel> {
      return this.httpClient.get<LeadModel>(this._globals.baseAPIUrl + 'CampMem/' + id).pipe(
   ...
   getLeadSubmit(data: LeadModel) {
      ...
      switch (data.entryMode) {
          ...
          case 'A': {
          return this.http.post(this._globals.baseAPIUrl + 'CampMem/create', data, this._cf.requestOptions()).pipe(
          ...
          case 'E': {
          return this.http.post(this._globals.baseAPIUrl + 'CampMem/edit', data, this._cf.requestOptions()).pipe(
          map((response: Response) => {
          return response.json();
          }), catchError(this._cf.handleError));
          }
          ...
          case 'D': {
          return this.http.post(this._globals.baseAPIUrl + 'CampMem/delete', data, this._cf.requestOptions()).pipe(
          map((response: Response) => {
          return response.json();
          }), catchError(this._cf.handleError));
          }
